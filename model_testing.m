...
for k = mod1
    for j = mod1
        idx = idx+1;
        p_mod = [ ];
        init_mod = {'MEK',start_val*10^j; 'ERK', start_val*10^k};
        
        doses = exp(7:.25:10); % Model perturbation: elevated RasGTP (should be in the neighborhood of 2000-20000 molecules)
